...
- **Cognitive & Resilience Architecture:** extends distributed decisions with reflex arcs, peripheral autonomy, sensory fusion, attention, homeostasis, platform immunity, operational memory, habituation, damage-risk modeling, adaptive recovery, and maintenance windows — [bio-inspired-architecture.md](docs/bio-inspired-architecture.md).
