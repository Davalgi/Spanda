...
- **Decision SDK and showcase parity:** `list_decision_traces` in Rust/Python SDKs; gRPC decision endpoint tests; Control Center v3 trace timeline table; fixed distributed-decisions sub-showcase parser syntax.
