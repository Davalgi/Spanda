...
- **Operational Governance Framework:** new `spanda-governance` crate — autonomy levels (0–5), deployment maturity, certification lifecycle (independent from health), deployment profiles (19 built-in contexts), operational risk model, governance policies, standards profile references (package-driven, no embedded regulatory text), human accountability, and operational constraints. Entity model extensions (`EntityGovernanceMeta` on `EntityRecord`). REST: `GET /v1/governance`, `/v1/compliance`, `/v1/certifications`, `/v1/deployment-profiles`, `/v1/risk`; `POST /v1/compliance/check`, `/v1/governance/validate`. gRPC proto **1.0.12**: `GetGovernance`, `GetCompliance`, `CheckCompliance`, `ValidateGovernance`, `ListCertifications`, `ListDeploymentProfiles`, `GetDeploymentProfile`, `GetOperationalRisk`. CLI: `spanda compliance check`, `governance validate|report`, `certification list|inspect`, `deployment profile`, `risk report`. SDK clients: `GovernanceClient`, `ComplianceClient`, `CertificationClient`, `DeploymentProfileClient`, `RiskClient` (Rust/Python/TypeScript). Control Center **Governance** tab. Docs: [governance.md](docs/governance.md), [compliance-framework.md](docs/compliance-framework.md), [certification-lifecycle.md](docs/certification-lifecycle.md), [deployment-profiles.md](docs/deployment-profiles.md), [autonomy-levels.md](docs/autonomy-levels.md), [risk-model.md](docs/risk-model.md), [human-accountability.md](docs/human-accountability.md), [standards-profiles.md](docs/standards-profiles.md), [governance-migration.md](docs/governance-migration.md). Examples: [examples/governance/](examples/governance/).
