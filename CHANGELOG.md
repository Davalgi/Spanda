...
- **Control Center UI token persistence:** embedded HTML remembers operator Bearer tokens in `localStorage` (opt-in, origin-scoped) with server verification on save and **Forget token** to clear.
