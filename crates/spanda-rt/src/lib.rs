...
fn log_event(msg: String) {
    ...
    //
    // Example:
    //     let result = spanda_rt::log_event(sg);
...
fn events_since(start: usize) -> Vec<String> {
    ...
    // Outputs:
    //     result: Vec<String>
    //         Return value from `events_since`.
    //
    // Example:
    //     let result = spanda_rt::events_since(star);
