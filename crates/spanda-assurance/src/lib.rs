...
pub use recovery::{
    ...
    load_merged_recovery_knowledge, load_recovery_knowledge_store, merge_recovery_knowledge,
    operational_modes_from_program, parse_self_correction, plan_fleet_recovery,
    record_recovery_outcome, recovery_from_diagnosis, save_recovery_knowledge_store,
