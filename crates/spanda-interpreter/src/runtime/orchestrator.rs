...
pub struct Interpreter<B: RobotBackend> {
    ...
    pending_decision_escalations: std::collections::HashSet<String>,
    granted_decision_escalations: std::collections::HashSet<String>,
    offline_since_ms: Option<f64>,
...
impl<B: RobotBackend> Interpreter<B> {
    pub fn new(backend: B, mut options: InterpreterOptions) -> Self {
        ...
        Self {
            ...
            pending_decision_escalations: std::collections::HashSet::new(),
            granted_decision_escalations: std::collections::HashSet::new(),
