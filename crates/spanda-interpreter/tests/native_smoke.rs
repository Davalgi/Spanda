...
fn native_interpreter_construct_and_options_default() {
    // Description:
    //     Native interpreter construct and options default.
    //
    // Inputs:
    //     None.
    //
    ...
    //     let result = spanda_interpreter::native_smoke::native_interpreter_construct_and_options_default();
...
fn native_crate_builds_without_spanda_core() {
    // Description:
    //     Native crate builds without spanda core.
    //
    // Inputs:
    //     None.
    //
    ...
    //
    // Example:
    //     let result = spanda_interpreter::native_smoke::native_crate_builds_without_spanda_core();
...
fn sim_robot_backend_type_alias_matches_simulator() {
    ...
    //     let result = spanda_interpreter::native_smoke::sim_robot_backend_type_alias_matches_simulator();
    ...
    fn assert_sim_type<T: spanda_interpreter::RobotBackend>() {
        ...
        //
        // Example:
        // let result = spanda_interpreter::native_smoke::assert_sim_type();
    }
