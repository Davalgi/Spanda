...
| **Fleet & OTA** | [`spanda-fleet`](spanda-fleet/README.md), [`spanda-ota`](spanda-ota/README.md), [`spanda-deploy-http`](spanda-deploy-http/README.md), [`spanda-entity-mesh`](spanda-entity-mesh/README.md) | Fleet orchestration, rollout agents, HTTP deploy, **Autonomous Entity Mesh** |
