//! Spanda language lexer — tokenization, keywords, and unit suffix lexemes.
//!
use spanda_ast::nodes::UnitKind;
use std::fmt;

/// Lexer diagnostic returned when tokenization fails.
...
fn keywords() -> HashMap<&'static str, TokenType> {
    ...
    HashMap::from([
        ...
        ("fleet", TokenType::Fleet),
        ("swarm", TokenType::Swarm),
        ("policy", TokenType::Policy),
        ("safety_zone", TokenType::SafetyZone),
