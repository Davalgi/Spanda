...
pub const REST_V1_ROUTES: &[ApiRoute] = &[
    ...
    ApiRoute {
        method: "GET",
        path: "/v1/plugins/control-center/{plugin}/bundle",
    },
    ApiRoute {
        method: "GET",
    ...
    ApiRoute {
        method: "GET",
        path: "/v1/decisions/traces",
    },
    ApiRoute {
        method: "GET",
        path: "/v1/decision-policy-cache",
    },
    ApiRoute {
        method: "POST",
    ...
    ApiRoute {
        method: "POST",
        path: "/v1/programs/contract/verify",
    },
    ApiRoute {
        method: "POST",
        path: "/v1/programs/explain",
    },
    ApiRoute {
        method: "POST",
        path: "/v1/programs/audit/decisions",
    },
    ApiRoute {
        method: "POST",
    ...
    ApiRoute {
        method: "GET",
        path: "/v1/analytics/what-if",
    },
    ApiRoute {
        method: "GET",
        path: "/v1/analytics/mission-risk",
    },
    ApiRoute {
        method: "GET",
        path: "/v1/analytics/readiness-forecast",
    },
    ApiRoute {
        method: "GET",
        path: "/v1/analytics/trust-graph",
    },
    ApiRoute {
        method: "GET",
    ...
    ApiRoute {
        method: "POST",
        path: "/v1/governance/policies/detach",
    },
    ApiRoute {
        method: "GET",
