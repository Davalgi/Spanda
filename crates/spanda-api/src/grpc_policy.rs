...
pub const PROTO_SEMVER: &str = "1.0.11";
...
/// gRPC server reflection is enabled when tonic-reflection is compiled in.
...
pub fn policy_json() -> Value {
    json!({
        ...
        "discovery": "Download control_center.proto from the repository or call GET /v1/version for the pinned proto_semver; grpcurl can use server reflection when enabled.",
    })
}
