...
| Production releases | ✅ SDK **0.5.9** on crates.io, PyPI, npm; ✅ desktop **0.4.2** (`desktop-v0.4.2` → initial Stable promotion GitHub Release); **current desktop** **0.6.3** (`desktop-v0.6.3`) — [control-center-versioning.md](./control-center-versioning.md) |
