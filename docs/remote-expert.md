...
Remote expert workflows connect **field technicians** with **off-site specialists** through AR
glasses, live robot cameras, annotations, and Spanda's diagnosis, assurance, replay, and audit
spine.

**Related:** [ar-vr-xr.md](./ar-vr-xr.md) · [spatial-computing.md](./spatial-computing.md) ·
[hri.md](./hri.md)
...
3. **Live robot camera** streams via existing vision provider (`spanda-opencv`, body cam,
