...
Maintain a digital representation of mission feasibility — readiness, assurance, and mission
contract alignment.
...
Extends existing `twin` blocks and `spanda-readiness` twin module. Local twin in core; cloud sync
via **`spanda-twin-cloud`** crate and Twin Cloud SaaS REST (`/v1/twins/*`) — see
[twin-cloud.md](./twin-cloud.md).

Showcase: `examples/showcase/mission_twin/patrol.sd` · `spanda demo mission-twin` ·
