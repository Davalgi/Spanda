...
> **Canonical roadmap moved.** The full product roadmap — Platform Pillars, Official Solution
> Blueprints, ownership model, dependency maps, and timeline — lives at the repository root:
>
...
device/fleet, security, operations, developer tooling, packages, and 15 industry solution
blueprints. Root-level **`ROADMAP.md`** improves discoverability for new visitors and aligns
Spanda's presentation as a **product ecosystem** rather than only a GitHub repository.
...
**Nothing was removed.** All prior roadmap content is classified under [Platform
Pillars](../ROADMAP.md#platform-pillars) and [Official Solution
Blueprints](../ROADMAP.md#official-solution-blueprints) in `ROADMAP.md`.
