...
| **Enterprise operations (LATER)** | PDF reporting, Tauri desktop — **Planned**; WebSocket telemetry SDK, OTLP trace export to Jaeger — **Experimental**; Compliance export UI, Digital Thread, Executive dashboards — **Experimental** (E4) |
