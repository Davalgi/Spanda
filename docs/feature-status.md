...
| **Operational Governance** | Autonomy levels, deployment profiles, certification lifecycle, risk, accountability, standards profiles; `spanda compliance check`, `governance validate|report`, `certification list|inspect|report`, `deployment profile|verify`, `risk report`; REST/gRPC `/v1/governance/*`; Control Center Governance tab — **Experimental** — [governance.md](./governance.md) · [governance-migration.md](./governance-migration.md) |
