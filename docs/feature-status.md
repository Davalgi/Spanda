...
| **Platform maturity (Phase C)** | Chaos engineering (`spanda chaos`), readiness trends (`spanda readiness trends`) — **Experimental** |
| **Platform maturity (Phase C–D)** | Readiness trends, resource estimation, compliance profiles, ADR |
