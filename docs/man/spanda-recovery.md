...
**`recovery simulate`** / **`recovery dry-run`** / **`recovery validate`** — Simulate or validate recovery without side effects.

**`recovery execute`** — Execute orchestrator recovery (requires operator approval for high-risk actions).

**`recovery history`** / **`recovery metrics`** / **`recovery graph`** / **`recovery playbooks`** — Query orchestrator evidence, metrics, dependency graph, and playbook catalog.
