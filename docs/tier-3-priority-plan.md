...
| 5 | **Remote package registry (minimal)** | `spanda install` from hosted index; 2+ curated packages; CI (`registry-golden-path`) | **Complete** |

Golden path index: [tier-3-golden-paths.md](./tier-3-golden-paths.md) § v0.5 beta (P0).
