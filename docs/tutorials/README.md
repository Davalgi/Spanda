...
Audience-specific entry points (mirrors [README § Where Should I Start](../../README.md#where-should-i-start)):
...
- Try assurance and readiness: `spanda demo assurance` or `spanda readiness` / `spanda assure` / `spanda diagnose` on showcase examples
